...
Bot.prototype.handlePlaceAttack = function handlePlaceAttack (data) {
  ...
  while (toProcess.length > 0) {
    ...
    neighboringEnemies.sort(function sortByPower (a, b) {
    ...
    for (i = 0; i < neighboringEnemies.length; ++i) {
      ...
      var maxAttack = currentRegion.troopCount - 1
      var minAttack = Math.ceil(targetRegion.troopCount * 1.5)
      ...
      var needed = minAttack - maxAttack
    ...
    neighboringNeutrals.sort(function sortByPower (a, b) {
      var aValue = (100 -
                    (a.troopCount * 10) +
                    (a.superRegion.bonus * 10) +
                    a.neighbors.length)
